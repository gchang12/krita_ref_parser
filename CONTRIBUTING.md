...
Welcome to `kritaref_parser` contributor's guide.
...
If you experience bugs or general issues with `kritaref_parser`, please have a look
...
You can help improve `kritaref_parser` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`kritaref_parser` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `kritaref_parser`'s files. While this mechanism can
...
```
conda create -n kritaref_parser python=3 six virtualenv pytest pytest-cov
conda activate kritaref_parser
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/kritaref_parser.git
   cd kritaref_parser
   ```
...
5. Install [pre-commit]:
   ...
   `kritaref_parser` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/kritaref_parser
[issue tracker]: https://github.com/<USERNAME>/kritaref_parser/issues
