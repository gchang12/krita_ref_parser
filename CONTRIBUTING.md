...
Welcome to `kritaref_palette` contributor's guide.
...
If you experience bugs or general issues with `kritaref_palette`, please have a look
...
You can help improve `kritaref_palette` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`kritaref_palette` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `kritaref_palette`'s files. While this mechanism can
...
```
conda create -n kritaref_palette python=3 six virtualenv pytest pytest-cov
conda activate kritaref_palette
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/kritaref_palette.git
   cd kritaref_palette
   ```
...
5. Install [pre-commit]:
   ...
   `kritaref_palette` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/kritaref_palette
[issue tracker]: https://github.com/<USERNAME>/kritaref_palette/issues
